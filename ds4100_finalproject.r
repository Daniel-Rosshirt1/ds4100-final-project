...
# ggplot2 plotting
library(ggplot2)
ggplot(df2015, aes(x=easternteams, y=easternW, fill=easternteams)) +
  geom_bar(stat="identity")+theme_minimal()
rankedByPAGTier5

ggplot(rankedByPAGTier5, aes(x=easternPAG, y=easternW, fill=easternteams)) +
  geom_bar(stat="identity")+theme_minimal()

ggplot(rankedByPSGTier5, aes(x=easternPSG, y=easternW, fill=easternteams)) +
  geom_bar(stat="identity")+theme_minimal()

ggplot(rankedByPAGTier4, aes(x=easternPAG, y=easternW, fill=easternteams)) +
  geom_bar(stat="identity")+theme_minimal()

ggplot(rankedByPSGTier4, aes(x=easternPSG, y=easternW, fill=easternteams)) +
  geom_bar(stat="identity")+theme_minimal()

ggplot(rankedByPAGTier3, aes(x=easternPAG, y=easternW, fill=easternteams)) +
  geom_bar(stat="identity")+theme_minimal()

ggplot(rankedByPSGTier3, aes(x=easternPSG, y=easternW, fill=easternteams)) +
  geom_bar(stat="identity")+theme_minimal()

ggplot(rankedByPAGTier2, aes(x=easternPAG, y=easternW, fill=easternteams)) +
  geom_bar(stat="identity")+theme_minimal()

ggplot(rankedByPSGTier2, aes(x=easternPSG, y=easternW, fill=easternteams)) +
  geom_bar(stat="identity")+theme_minimal()

ggplot(rankedByPAGTier1, aes(x=easternPAG, y=easternW, fill=easternteams)) +
  geom_bar(stat="identity")+theme_minimal()

ggplot(rankedByPSGTier1, aes(x=easternPSG, y=easternW, fill=easternteams)) +
  geom_bar(stat="identity")+theme_minimal()
